...
import com.familydoctor.auth.filter.JwtAuthFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                // 允许内部异步分发和错误页转发，防止流式输出完成后容器重定向触发二次 AccessDenied
                ...
                .requestMatchers("/api/v1/payments/wx/callback").permitAll()
                .requestMatchers("/api/v1/payments/ali/callback").permitAll()
